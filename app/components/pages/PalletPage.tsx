    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(170px, 1fr))', gap: '14px', marginBottom: '18px' }}>
        ...
        <div className="stat-card yellow">
          ...
          <div className="stat-sub">{angkutanDariAbsen ? `mengikuti absen hari ini (${absenPalletHariIni} pallet)` : 'sedang dibawa truk (angka manual)'}</div>
        </div>
